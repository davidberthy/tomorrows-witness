...
export default function TomorrowsWitness() {
  ...
  const metaculus = markets.filter((m) => m.source === "Manifold");
    ...
    >
      ...
      {view === "signals" && (
        ...
        >
          ...
          >
            AI-curated from{" "}<a href="https://polymarket.com" target="_blank" rel="noopener" style={{color:"var(--amber)",textDecoration:"none",borderBottom:"1px solid var(--amber-dim)"}}>Polymarket</a>{" "}and{" "}<a href="https://manifold.markets" target="_blank" rel="noopener" style={{color:"var(--amber)",textDecoration:"none",borderBottom:"1px solid var(--amber-dim)"}}>Manifold</a> — the most strategically interesting questions people are betting real money on right now.
